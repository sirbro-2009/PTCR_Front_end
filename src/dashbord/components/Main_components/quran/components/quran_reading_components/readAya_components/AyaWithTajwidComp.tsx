...
return (<>
      <style>{`@font-face {
              ...
              src: url('https://static-cdn.tarteel.ai/qul/fonts/quran_fonts/v4-tajweed/ttf/p${pageNumber}.ttf') format('truetype');
              font-display: swap;}`}</style>
    <div className={`font-[Tajweed] dark:tajweed-dark-invert  whitespace-normal wrap-break-word ${className?'text-4xl w-fit my-2':` w-full  m-auto text-center p-4 text-xl md:text-3xl`} text-4xl `}>
        {aya}
    </div>
</>)
}